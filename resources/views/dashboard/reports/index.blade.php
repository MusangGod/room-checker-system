        ...
        <div class="flex justify-between items-center gap-3 mt-4">
            ...
            <form method="get" class="flex gap-3 items-center justify-end">
                ...
                <select name="month" id="month" required style="width: 170px !important;">
                    ...
                    <option value="3" {{ (collect($month)->contains(3)) ? 'selected' : '' }}>Maret</option>
                    <option value="4" {{ (collect($month)->contains(4)) ? 'selected' : '' }}>April</option>
                    <option value="5" {{ (collect($month)->contains(5)) ? 'selected' : '' }}>Mei</option>
                    <option value="6" {{ (collect($month)->contains(6)) ? 'selected' : '' }}>Juni</option>
                    <option value="7" {{ (collect($month)->contains(7)) ? 'selected' : '' }}>Juli</option>
                    <option value="8" {{ (collect($month)->contains(8)) ? 'selected' : '' }}>Agustus</option>
                    <option value="9" {{ (collect($month)->contains(9)) ? 'selected' : '' }}>September</option>
                    <option value="10" {{ (collect($month)->contains(10)) ? 'selected' : '' }}>Oktober</option>

    ...
    <div class="table-wrapper mt-[20px] input-teacher">
        ...
        <form action="{{ route('staffs.store') }}" method="post" enctype="multipart/form-data" class="grid grid-cols-12 gap-4">
            ...
            <div class="col-span-12 md:col-span-6 flex flex-col">
                ...
                <input type="text" class="input-crud" name="staff_number" id="staff_number" value="{{ old('staff_number') }}"
            ...
            <div class="col-span-12 flex flex-col">
                ...
                <label for="image_path" class="d-block mb-3">
                    <img src="{{ asset('assets/img/upload-image.jpg') }}" class="create-staff-preview-img border"
                        width="300" alt="">
                </label>
                <input type="file" id="image_path" name="image_path"
                    class="input-crud py-0 create-staff-input hidden" />
            ...
            <div class="col-span-12 flex items-center gap-3 mt-2">
                ...
                <a href="{{ route('staffs.index') }}" class="button btn-second text-white" type="reset">Batal
                    Tambah</a>
            </div>
        </form>
    </div>
